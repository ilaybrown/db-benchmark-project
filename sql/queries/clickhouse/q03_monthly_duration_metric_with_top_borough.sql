WITH base AS (
    SELECT
        *,
        ...
        formatDateTime(date_of_report, '%Y-%m') AS year_month
...
top_borough AS (
    SELECT
        ...
        lengthUTF8(MIN(borough)) AS top_borough_len
...
SELECT
    ...
    ms.uniq_dates,
    tb.top_borough,
    (ms.sum_duration / nullIf(ms.uniq_dates, 0)) * tb.top_borough_len AS monthly_metric
