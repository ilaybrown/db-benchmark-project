...
-- DATABASE: POSTGRESQL
-- PURPOSE: Test single-statement and multi-statement rollback behavior.

-- section: cleanup
DELETE FROM acid_audit
WHERE test_case IN ('atomicity_single_statement', 'atomicity_multi_statement');
...
VALUES
    ...
    (1001003, 'atomicity_single_statement', 'Manhattan', -4);
